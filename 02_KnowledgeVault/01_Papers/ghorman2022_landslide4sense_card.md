...
**Benchmark Paper** —Introduces Landslide4Sense, a reference benchmark for landslide detection from remote sensing, including dataset, evaluation protocol, and baseline deep learning models.
...
4. Sentinel-2 alone is insufficient —DEM/slope layers are critical
