...
```
Zotero (D:\ResearchAI_Data\Zotero\storage\)
    ︙
...
| Directory | Reason |
|---|---|
| `Markdown/` | MinerU output lives on D: drive, not here |
| `PDFs/` | PDFs are managed by Zotero (ADR-001) |
| `01_PDFs/` | Duplicate of PDFs/, also deprecated |
| `02_MinerU_Output/` | MinerU output lives on D: drive |
...
- **Replaced by** `D:\ResearchAI_Data\Paper\MinerU_md\` — actual MinerU output location
- **Replaced by** `D:\ResearchAI_Data\Zotero\` — actual PDF storage location
