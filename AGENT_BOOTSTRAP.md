...
| Stage | Status |
|---|---|
| Stage 0 —Workspace Initialization | 鉴Completed |
| Stage 1.1 —Obsidian KnowledgeVault Init | 鉴Completed |
| Stage 1.2 —Obsidian Note Templates | 鉴Completed |
| Stage 1.3 —Navigation & Knowledge Graph | 鉴Completed |
| Stage 1.4A —First Paper Validation | 鉴Completed |
| Stage 1.4A.1 —Agent Bootstrap | 鉴Completed |
| Stage 1.4B-0 —Literature Intake System | 鉴Completed |
| Stage 1.4B-1 —Processed Markdown Pipeline | 鉴Completed |
| Stage 1.4C-0 —Zotero Integration Design | 鉴Completed |
| Stage 1.4C-1 —Zotero Deployment Prep | 鉴Completed |
| Stage 1.4C-1.1 —Design Principles & ID Fix | 鉴Completed |
| Stage 1.4C-2 —Zotero Test Plan | 鉴Completed |
| Stage 1.4C-3 —Zotero Readiness | 鉴Completed |
| Stage 1.4C-3.1 —Data Path Sync | 鉴Completed |
| Stage 1.4C-3.2 —Zotero Status Sync | 鉴Completed |
| Stage 1.4C-3.3 —Storage Confirmation | 鉴Completed |
| **Stage 1.4C-3.4 —PDF Architecture Redesign** | 馃攧 Current |
| Stage 1.4B —Survey Template & Data Setup | —Next |
...
| Directory | Purpose |
|---|---|
| `00_Inbox/` | Temporary input area —new papers, notes, unprocessed files |
| `01_Literature/` | Literature management —MinerU output, processed markdown, index |
| `02_KnowledgeVault/` | Obsidian knowledge base —the intellectual memory of the project |
| `03_Projects/` | Research implementation —DL code, training scripts, configs |
| `04_Tools/` | Reusable scripts —preprocessing, conversion, visualization |
| `05_Experiments/` | Experiment tracking —configs, results, figures |
| `06_Writing/` | Scientific writing —drafts, manuscripts, proposals |
| `07_Research_Ideas/` | Idea management —gaps, hypotheses, future directions |
| `08_Agent_Config/` | AI agent config —instructions, skills, templates, workflows |
...
1. **Read `AGENT_BOOTSTRAP.md`** —understand project identity, constraints, and status.
2. **Read `PROJECT_STATUS.md`** —understand completed stages and next planned work.
3. **Read `README.md`** —understand overall project design and principles.
4. **Read the current task document** —understand what you are being asked to do.
...
Check in order:
1. MinerU_Zotero_Mapping.md — search by Zotero Item Key and Paper ID.
| `08_Agent_Config/ResearchAI_Skill_Guide_CN.md` | Skill system user guide (Chinese) |
| `08_Agent_Config/Skills/` | Skill framework directory — standardized agent procedures |
2. Paper_Index.md — search by filename pattern.
3. 02_KnowledgeVault/01_Papers/ — search for matching {author}{year}_* files.
...
- **Mentioned in paper** —a dataset the paper references but did not personally use
- **Personally used** —a dataset the paper actually ran experiments on
- **Benchmark target** —a dataset used as a standard evaluation target
